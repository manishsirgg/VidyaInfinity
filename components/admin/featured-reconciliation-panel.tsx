...
export function FeaturedReconciliationPanel() {
  ...
  async function fetchData() {
    ...
    try {
      ...
      const freshRows = [
        ...(mapRows(body.instituteOrders ?? [], "institute")),
        ...(mapRows(body.courseOrders ?? [], "course")),
        ...(mapRows(body.webinarOrders ?? [], "webinar")),
      ];
      setRows(freshRows);
      return freshRows;
    } catch (e) {
